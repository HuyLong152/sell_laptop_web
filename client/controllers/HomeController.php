    ...
    public function forgotpass()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($customer!=null) {
                ...
                $mail->Body = "Để khôi phục mật khẩu, vui lòng truy cập: http://localhost/nhom4/?controller=home&action=resetpass&recoverycode=".$recoverycode."  Link có hiệu lực trong 5 phút!";
